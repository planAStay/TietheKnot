          ...
          <div className={clsx('fixed inset-y-0 flex max-w-full', openFrom === 'right' && 'right-0')}>
            <DialogPanel
              ...
              className={clsx(
                ...
                'h-screen w-screen translate-x-0 overflow-hidden bg-white text-start align-middle shadow-xl',
                animated &&
            ...
            >
              <div className="flex h-full flex-col px-4 md:px-8">
                <header
                  className={`flex h-16 flex-shrink-0 items-center border-b border-[#d4a5a5]/30 md:h-20 ${
                ...
                >
                  {hasHeading && (
                    <>
                      {!!heading && !logoOnHeading && (
                        <DialogTitle>
                          <span className="font-serif text-2xl font-medium text-[#5a4a42]">{heading}</span>
                        </DialogTitle>
                      )}
                      {logoOnHeading && <Logo />}
                    </>
                  ...
                  <button type="button" className="group -m-4 cursor-pointer p-4 text-[#5a4a42] hover:text-[#d4a5a5]" onClick={onClose}>
                    <HugeiconsIcon
