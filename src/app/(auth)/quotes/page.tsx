      ...
      {filteredQuotes.length === 0 ? (
        <div className="rounded-lg border border-dashed border-primary/40 bg-white p-6 text-center">
          <Text className="text-sm text-zinc-600">
            {filterStatus === 'ALL' 
              ? 'No quote requests yet. Browse vendors and request quotes to get started.'
            ...
            >
              <div className="flex items-start justify-between gap-4">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  {quote.status === 'QUOTED' && (
                    <span className="text-xs font-medium text-rose-600">View & Respond</span>
                  )}
                </div>
              </div>
            </Link>
